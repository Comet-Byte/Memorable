...
## The Memorable Approach: Keep It Simple
...
### Your action plan:
1. **[Go to Memorable](/create/invoice)** right now
...
**[Try the 3-step process today](/create/invoice)** and see what invoicing feels like when it's designed for humans, not accountants.
